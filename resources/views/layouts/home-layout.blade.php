                                ...
                                <div class="frame pull-right">
                                    ...
                                    <div class="profiles-box pull-right active">
                                        ...
                                        <ul class="tools tools-middle pull-left">
                                            <li><a href="http://fb.me/novaymawbowo" target="_blank"><span
                                                        class="fa-icon-facebook-sign"></span></a></li>
                                            <li><a href="http://twitter.com/NovayMawbowo" target="_blank"><span
                                                        class="fa-icon-twitter"></span></a></li>
                                            <li><a href="http://google.com/+NovayMawbowo" target="_blank"><span
                                                        class="fa-icon-google-plus"></span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="collapse navbar-collapse">
                                                ...
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li class="dropdown"><a class="dropdown-toggle"
                                                            data-toggle="dropdown">Profil Sekolah</a>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="identitas.html">Identitas</a></li>
                                                            <li><a href="visi-misi.html">Visi &amp; Misi</a></li>
                                                            <li><a href="sarana-prasarana.html">Sarana &amp;
                                                                    Prasarana</a></li>
                                                            <li><a href="program-kegiatan.html">Program &amp; Kegiatan
                                                                </a></li>
                                                    ...
                                                    <li class="dropdown"><a class="dropdown-toggle"
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a href="daftar-guru.html">Daftar Guru &amp; Staff</a>
                                                            </li>
        ...
        <div class="tengah" id="main">
            ...
            <section class="gallery">
                <div id="onebyone_carousel" class="carousel slide gallery-holder">
                    <div class="carousel-inner">
                            ...
                            <div class="slide_content">
                                <div class="container gambar-gerak">
                                    <div class="hold-text pull-right">
                                        <strong class="title animate0 rotateIn" style="opacity: 0;">Selamat
                                            Datang</strong>
                                        <div class="hold animate1 rotateIn" style="opacity: 0;">
                                            <p>Ini adalah website resmi SMK Negeri 1 Berau. Semoga dengan adanya website
                                                ini segala informasi dapat tersampaikan dengan <i>up-to-date.</i> Lihat
                                                Sambutan Kepala Sekolah kami di tombol berikut...</p>
                                        </div>
                                        <a href="#kepala-sekolah"
                                            class="btn btn-default btn-lg btn-white animate2 rotateIn"
                                            style="opacity: 0;">Sambutan</a>
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.item -->
                        <div class="item">
                            ...
                            <div class="slide_content">
                                <div class="container gambar-gerak">
                                    <div class="hold-text pull-right">
                                        <strong class="title animate0 rotateIn" style="opacity: 0;">Biru, Hijau,
                                            Asri</strong>
                                        <div class="hold animate1 rotateIn" style="opacity: 0;">
                                            <p>Dengan sangat bangga kami dedikasikan keindahan serta kecantikan sekolah
                                                kami dari dunia oleh dunia dan untuk dunia.</p>
                                        </div>
                                        <a href="#kepala-sekolah"
                                            class="btn btn-default btn-lg btn-white animate2 rotateIn"
                                            style="opacity: 0;">Sambutan</a>
                        ...
                        <div class="item">
                            ...
                            <div class="slide_content">
                                <div class="container gambar-gerak">
                                    <div class="hold-text pull-right">
                                        <strong class="title animate0 rotateIn" style="opacity: 0;">Find your
                                            Target.</strong>
                                        <div class="hold animate1 rotateIn" style="opacity: 0;">
                    ...
                    <a class="link-prev carousel-control" href="#onebyone_carousel" data-slide="prev"><i
                            class="im-icon-arrow-left-4"></i></a>
                    <a class="link-next carousel-control" href="#onebyone_carousel" data-slide="next"><i
                            class="im-icon-arrow-right-5"></i></a>
                </div><!-- /.carousel -->
            </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-6">
                        ...
                        <div class="container">
                            <h2 style="font-family:Open Sans, sans-serif"><i class="fa-icon-info"></i> <b>Kabar
                                    Sekolah</b></h2>
                            <hr />
                            ...
                            <div class="col-sm-12">
                                <blockquote class="blockquote-about">
                                    ...
                                    <div class="block">
                                        <span class="nook">&nbsp;</span>
                                        <strong class="title"><a href="kabar-sekolah-detail.html"><b>SEMANGAT BELAJAR
                                                    MENGHADAPI UJIAN SEKOLAH</b></a>
                                            <small>Terbit pada tanggal 29 Desember 2013 | <a
                                                    href="kabar-sekolah-detail.html#komentar">5 Komentar</a></small>
                                        </strong>
                                        <q>Haloo... para siswa siswi SMKN 1 Berau terutama kelas XII siap-siap ya
                                            tanggal xx - xx xxx 2014 kalian akan menghadapi Ujian Sekolah Tahun 2014
                                            dimana jadwal ujiannya sudah ada di web SMKN 1 Berau. Jangan lupa selalu
                                            belajar biar kalian semua siap menghadapinya. Matikan TV, HP, Kom... </q> <a
                                            href="kabar-sekolah-detail.html">Baca selengkapnya...</a>
                                    </div>
                                </blockquote>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <blockquote class="blockquote-about">
                                    ...
                                    <div class="block">
                                        <span class="nook">&nbsp;</span>
                                        <strong class="title"><a href="kabar-sekolah-detail.html"><b>CLASS
                                                    MEETING</b></a>
                                            <small>Terbit pada tanggal 28 Desember 2013 | <a
                                                    href="kabar-sekolah-detail.html#komentar">12 Komentar</a></small>
                                        </strong>
                                        <q>Asslamualaikum kawan.. Tak terasa sudah mau bagi rapot dan class meeting
                                            sekolah kita yang seru sudah berakhir. Ini dia hasil pertandingan antar
                                            kelas (class meeting) SMKN 1 Berau. Selamat ya untuk kawan-kawan yang sudah
                                            menang :) FUTSAL PUTRA Juara 1 : XII... </q> <a
                                            href="kabar-sekolah-detail.html">Baca selengkapnya...</a>
                                    </div>
                                </blockquote>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <blockquote class="blockquote-about">
                                    ...
                                    <div class="block">
                                        <span class="nook">&nbsp;</span>
                                        <strong class="title"><a href="kabar-sekolah-detail.html"><b>DESIGN GEDUNG
                                                    BARU</b></a>
                                            <small>Terbit pada tanggal 15 Desember 2013 | <a
                                                    href="kabar-sekolah-detail.html#komentar">23 Komentar</a></small>
                                        </strong>
                                        <q>SMP Negeri 34 Samarinda sedang melakukan renovasi gedung yang insya Allah
                                            akan dapat dipergunakan mulai desember 2012. Berikut design gedung yang
                                            rencananya akan digunankan sebagai ruang kelas ini : Foto gedung tampak dari
                                            depan Foto gedung tampak dari samping... </q> <a
                                            href="kabar-sekolah-detail.html">Baca selengkapnya...</a>
                                    </div>
                                </blockquote>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <blockquote class="blockquote-about">
                                    ...
                                    <div class="block">
                                        <span class="nook">&nbsp;</span>
                                        <strong class="title"><a href="kabar-sekolah-detail.html"><b>SELAMAT DATANG
                                                    WEBSITE RESMI SMKN 1 BERAU</b></a>
                                            <small>Terbit pada tanggal 10 Desember 2013 | <a
                                                    href="kabar-sekolah-detail.html#komentar">3 Komentar</a></small>
                                        </strong>
                                        <q>Kami keluarga besar SMKN 1 Berau turut berbahagia atas launchingnya website
                                            sekolah kami yang dapat diakses langsung pada http://smkn1berau.sch.id.
                                            Semoga website ini kedepannya dapat membantu banyak hal terutama dalam
                                            penyampaian informasi kepada siswa, guru, maupun warga di luar sekolah.
                                            Website ini dibuat sebagai media komunikasi dan kepek... </q> <a
                                            href="kabar-sekolah-detail.html">Baca selengkapnya...</a>
                                    </div>
                                </blockquote>
                            </div>
                        ...
                        <div class="crewman crewman-center">
                            <div class="frame sambutan" id="kepala-sekolah">
                                ...
                                <div class="hold-line">
                                    ...
                                    <p>Dalam era globalisasi ini layanan informasi yang cepat dan akurat menjadi
                                        kebutuhan masyarakat modern. Informasi yang terdistribusi secara efektif
                                        diyakini menjadi penggerak partisipasi seluruh warga terutama pemangku
                                        kepentingan (stakeholders) untuk mendukung program, mewujudkan harmoni
                                        antarsesama warga sekolah, membuka kran komunikasi dan tentu saja merupakan
                                        media publikasi keunggulan sekolah kepada masyarakat.</p>
                                    <p>Web SMK Negeri 1 Berau hadir sebagai media komunikasi dan informasi untuk seluruh
                                        stakeholders dan masyarakat luas. Pengelolaan web ini berada di bawah kendali
                                        Mahakam Tim Samarinda. Meski demikian, untuk up-date data dan informasi
                                        diperlukan kerja sama sinergis dengan seluruh bidang dan unit di lingkungan SMK
                                        Negeri 1 Berau.</p>
                                    <p>Untuk sementara, menu yang tersedia masih terbatas. Akan tetapi ke depan akan
                                        senantiasa dikembangkan sesuai dengan dinamisasi dan kebutuhan yang relevan.
                                        Selamat datang dan selamat berkunjung di web SMKN 1 Berau. Silakan kontak kami
                                        untuk memberikan masukan dalam rangka mewujudkan SMKN 1 sebagai sekolah yang
                                        Insya Allah penuh berkah-rahmat-hidayah, nyaman dan menyejukkan, religius, serta
                                        unggul dalam IPTEK.</p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="gallery-partners">
                            ...
                            <ul class="switcher">
                                <li class="active"><a href="#">switcher</a></li>
                                <li>
                                    <a href="#">switcher</a>
                                </li>
                                <li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-sm-6">
                            <p>&copy; 2014 Hak Cipta Dilindungi. Develop oleh <a href="http://novay.web.id/">Mahakam
                                    Team</a></p>
                        </div>
